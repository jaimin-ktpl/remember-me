...
namespace Ktpl\RememberMe\Helper;
...
class Data extends AbstractHelper {
    ...
    ScopeConfigInterface $scopeConfigInterface, CookieManagerInterface $cookieManager, CookieMetadataFactory $cookieMetadataFactory, SessionManagerInterface $sessionManager
    ) {
    ...
    public function delete($name) {
        $this->cookieManager->deleteCookie(
                $name, $this->cookieMetadataFactory
    ...
    public function getCookieloginChk() {
        ...
        if ($chk) {
            return $chk->remchkbox ? true : false;
        }
        return false;
    }
